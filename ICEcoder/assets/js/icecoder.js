...
var ICEcoder = {
    ...
    // Define settings
    filesW:	               250,           // 默认的宽度  Width of files pane 
    minFilesW:             14,            // Min width of files pane
    maxFilesW:             250,           // Max width of files pane
    selectedTab:           0,             // 默认第几个标签页   The tab that's currently selected
...
// modified by dfy
    ...
    discriptionScreen: function(file) {
        get('mediaContainer').innerHTML =
            '<iframe src="' +
            this.iceLoc +
            '/lib/showString.php?file=' +
            file +
            '&csrf=' +
            this.csrf +
    ...
    heatmapScreen: function(file) {
        get('mediaContainer').innerHTML =
            '<iframe src="' +
            this.iceLoc +
            '/lib/showHeatMap.php?file=' +
            file +
            '&csrf=' +
            this.csrf +
            '" id="versionsIFrame" style="width: 970px; height: 640px"></iframe>';
