...
<!--这里的parent.ICEcoder.files.style.background = '#383838'就是左边栏的背景色；parent.ICEcoder.files.style.background = '#444'就是当选中状态的颜色-->
...
<!--尝试增加一个refresh按钮
<div title="<?php echo $t['Refresh'];?>" onclick="parent.ICEcoder.refreshFileManager()" class="refresh2"><?php echo file_get_contents(dirname(__FILE__) . "/assets/images/icons/rotate-clockwise.svg");?></div>
-->
