...
<!--这里是人为加进去的2个框-->
<div id="files2" class="files2" onmouseover="ICEcoder.changeFilesW('expand')" onmouseout="ICEcoder.changeFilesW('contract'); ICEcoder.hideFileMenu();" oncontextmenu="return false">
	<!--<iframe id="filesFrame2" class="frame" name="ff2" src="<?php echo $iceURLPath;?>/files.php" style="opacity: 0" onLoad="this.style.opacity = '1'; this.contentWindow.onscroll = function(){ICEcoder.mouseDown = false; ICEcoder.mouseDownInCM = false}"></iframe>
		-->
	<div id="mylist" class="mylist" style="font-size: 30px;">
		<h4 style="margin-left: 20px;font-size: 16px;margin-top:10px ">缺陷跟踪：</h4>
		<ul>
			<li onclick="javascript:ICEcoder.openFile('|vul|2|file.c');javascript:ICEcoder.goToLine(40)">file.c @40</li>
			<li onclick="javascript:ICEcoder.openFile('|vul|2|avio.c');javascript:ICEcoder.goToLine(296)">avio.c @296</li>
			<li onclick="javascript:ICEcoder.openFile('|vul|2|avio.c');javascript:ICEcoder.goToLine(340)">avio.c @340</li>	
			<li onclick="javascript:ICEcoder.openFile('|vul|2|ffserver.c');javascript:ICEcoder.goToLine(2543)">ffserver.c @2543</li>
		</ul>
	</div>
</div>

<div id="files3" class="files3" onmouseover="ICEcoder.changeFilesW('expand')" onmouseout="ICEcoder.changeFilesW('contract'); ICEcoder.hideFileMenu();" oncontextmenu="return false">
	<div id="mylist" class="mylist" style="font-size: 30px;">
		<h4 style="margin-left: 20px;font-size: 30px;margin-top:10px ">误报概率：x%</h4>
		<h4 style="margin-left: 20px;font-size: 16px;margin-top:10px ">判断依据：</h4>
		<ul>
			<li onclick="javascript:ICEcoder.openFile('|vul|2|avio.c');javascript:ICEcoder.goToLine(206)">avio.c @206</li>
			<li onclick="javascript:ICEcoder.openFile('|vul|2|ffserver.c');javascript:ICEcoder.goToLine(2518)">ffserver.c @2518</li>
			<li onclick="javascript:ICEcoder.openFile('|vul|2|aviobuf.c');javascript:ICEcoder.goToLine(167)">aviobuf.c @167</li>
		</ul>
	</div>
...
<div class="footer" id="footer" oncontextmenu="return false">
	...
	<div class="splitPaneControls" id="splitPaneControls">
		<div class="off" id="description" title="<?php echo $t['Des show'];?>" onclick="ICEcoder.discriptionScreen(ICEcoder.openFiles[ICEcoder.selectedTab - 1].replace(/\//g, '|'))" style="opacity: 0.8"><?php echo file_get_contents(dirname(__FILE__) . "/assets/images/icons/square.svg");?>
		</div><div class="heat" id="heatmap" title="<?php echo $t['Heat map show'];?>" onclick="ICEcoder.heatmapScreen(ICEcoder.openFiles[ICEcoder.selectedTab - 1].replace(/\//g, '|'))" style="opacity: 0.2"><?php echo file_get_contents(dirname(__FILE__) . "/assets/images/icons/layout-columns.svg");?></div>
	</div>
